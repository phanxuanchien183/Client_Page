...
import { useChangeRoute, useMediaQuery, useUrlQuery, useTranslate } from '@/hooks'
          ...
          <div id="_products" className="w-full p-4 mt-3 ">
            ...
            <div className="divide-y-2 ">
              ...
              <div className="flex justify-between py-2">
                <span>{trans.product.all}</span>
                <span className="">{data?.data?.productsLength} {trans.common.product}</span>
              </div>
            </div>
            ...
            {isFetchingProduct ? (
              ...
              <section className="sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                {data?.data?.products.map(item => <ProductCard product={item} key={item.id} />)}
              </section>
            ) : (
