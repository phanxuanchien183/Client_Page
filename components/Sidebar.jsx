...
import { Icons, SidebarSkeleton, ResponsiveImage } from '@/components'
    ...
    <>
      ...
      >
        ...
        <div className="overflow-y-auto absolute py-4 top-0 right-0 z-20 w-3/4 h-screen max-w-sm space-y-4 bg-white">
          <ResponsiveImage
            dimensions="h-10 ml-3 w-28"
            className="overflow-hidden"
            src="/logo-htshalom.png"
            alt={`HT Shalom`}
          />
          <h5 className="p-3 border-t-2  border-gray-200">{trans.category.product_category}</h5>
          {isLoading ? (
            <SidebarSkeleton />
          ) : categoriesList ? (
            <div>
                                  ...
                                  <>
                                    ...
                                    >
                                      <Link
                                        ...
                                        onClick={handleClose}
                                      >
                                        Tất cả các danh mục con trong danh mục này
                                        <Icons.ArrowRight2 className="text-gray-500 icon" />
                                      </Link>
                                      {category.children &&
                                        category.children.map(category => (
