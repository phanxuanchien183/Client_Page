...
const CategoryForm = props => {
  ...
  return (
    <section className="p-3 md:px-3 xl:px-8 2xl:px-10">
      ...
      >
        <TextField label={trans.category.name} control={control} errors={formErrors.name} name="name" />

        <TextField
          label={trans.common.slug}
          control={control}
          errors={formErrors.slug}
          name="slug"
        />

        <TextField label={trans.common.image} control={control} errors={formErrors.image} name="image" />
