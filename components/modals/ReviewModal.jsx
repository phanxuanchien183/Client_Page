  ...
  return (
    <>
      ...
      <Modal isShow={isShow} onClose={onClose} effect="bottom-to-top">
        ...
        >
          <Modal.Header onClose={onClose}>Để lại đánh giá về {productTitle}</Modal.Header>
          <Modal.Body>
            <form
            ...
            >
              ...
              <div>
                <div className="my-2 text-center">
                  <span className="text-sm text-black">Điểm</span>
              ...
              <div className="py-3 border-t-2 border-gray-200 lg:pb-0 ">
                <SubmitModalBtn isLoading={isLoading}>Gửi đánh giá</SubmitModalBtn>
              </div>
            </form>
          </Modal.Body>
        </Modal.Content>
