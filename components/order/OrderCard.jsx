        ...
        <div className="flex items-center justify-between lg:px-3">
          <div className="flex items-center gap-x-2 ">
            ...
            <span className="text-sm text-black">
              {order?.delivered ? 'Hoàn thành' : 'Không xác nhận'}
            </span>
          </div>
              ...
              <div className="absolute left-0 z-10 hidden px-4 py-3 bg-white rounded shadow-3xl top-5 group-hover:flex">
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="block">Thay đổi trạng thái thành đã giao hàng</span>
                  </button>
                  <button
                    type="button"
                    className="flex items-center w-48 gap-x-3 lg:w-56"
                  ...
                  >
                    ...
                    <span className="block">Thay đổi trạng thái thành đang xử lý</span>
                  </button>
                </div>
              </div>
            </div>
