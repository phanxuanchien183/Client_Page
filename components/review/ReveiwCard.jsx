            ...
            <>
              <Menu.Item>
                ...
                >
                  ...
                  <span className="block">Trạng thái được thay đổi thành Đã được phê duyệt</span>
                </button>
              </Menu.Item>
              <Menu.Item>
                <button
                ...
                >
                  ...
                  <span className="block">Từ chối</span>
                </button>
              </Menu.Item>
            </>
          ) : deleteReviewHandler ? (
          ...
          <div className="pb-1 border-b border-gray-100 lg:flex lg:pb-3 lg:items-center justify-between">
            ...
            <div className="flex justify-between">
              ...
              >
                ...
                >
                  {status === 1 ? 'Chờ xác nhận' : status === 2 ? 'Đã được xác nhận' : 'none'}
                </span>
              </div>
              <DropdownReview />
            </div>
